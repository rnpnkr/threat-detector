...
def main():
    ...
    parser.add_argument('--config', default='standalone_gun_detector/configs/gun_detection.py', help='Config file path')
    parser.add_argument('--checkpoint', default='standalone_gun_detector/checkpoints/epoch_3.pth', help='Checkpoint file path')
